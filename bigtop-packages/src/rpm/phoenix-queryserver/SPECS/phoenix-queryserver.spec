...
%define phoenix_pkg_name %{phoenix_name}-queryserver%{pkg_name_suffix}
...
%define doc_phoenix %{parent_dir}/%{phoenix_name}/doc
...
Version: %{phoenix_queryserver_version}
Release: %{phoenix_queryserver_release}
Summary: Phoenix is a SQL skin over HBase and client-embedded JDBC driver.
URL: http://phoenix.apache.org
Group: Development/Libraries
Buildroot: %{_topdir}/INSTALL/%{name}-%{version}
License: ASL 2.0
Source0: %{phoenix_name}-queryserver-%{phoenix_queryserver_base_version}-src.tar.gz
Source1: do-component-build
Source2: install_phoenix_queryserver.sh
Source3: bigtop.bom
BuildArch: noarch
...
%prep
%setup -n %{phoenix_name}-queryserver-%{phoenix_queryserver_base_version}
...
# /usr/bin/hdp-select --rpm-mode set phoenix-server %{bigtop_install_dir}
...
%{phoenix_home}/bin/phoenix_queryserver_utils.py
%{phoenix_home}/bin/queryserver.py
%{phoenix_home}/bin/sqlline-thin.py
%{phoenix_home}/maven
%{phoenix_home}/lib
%{phoenix_home}/phoenix-queryserver-*.jar
%exclude %{phoenix_home}/bin/argparse-1.4.0
%exclude %{phoenix_home}/bin/daemon.py
%exclude %{phoenix_home}/bin/log4j.properties
%exclude %{phoenix_home}/phoenix-client-hbase-*.jar