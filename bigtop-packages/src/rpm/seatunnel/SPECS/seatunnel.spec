...
getent passwd seatunnel >/dev/null || useradd -c "Kyuubi" -s /sbin/nologin -g seatunnel -r -d %{lib_seatunnel} seatunnel 2>/dev/null || :
...
%files
%defattr(644,seatunnel,seatunnel,755)
%{lib_seatunnel}
